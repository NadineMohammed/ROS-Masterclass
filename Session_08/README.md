...
│   ├── images/                       # Screenshots (see Section 7 & 8)
│   ├── videos/                       # Demo videos + GIFs (see Section 7)
│   ├── CMakeLists.txt
│   └── package.xml
...
<img src="robot_navigation/images/ProcessOfCreatingHouseMap.png" width="480" alt="Process of Creating House Map">

The map being built live while driving the robot through the house world
with keyboard teleop.

<img src="robot_navigation/images/CreatingHouseMap.png" width="480" alt="Completed House Map">

<img src="robot_navigation/images/map.jpg" width="480" alt="Saved House Occupancy Grid Map">

The finished, saved occupancy grid map of the house world (`turtlebot3_house_map.pgm` / `.yaml`).

### AMCL Localization on the House Map

**Wrong initial pose:**

<img src="robot_navigation/images/WrongPoseTurtleHouse.png" width="480" alt="Wrong Pose - House World">

<img src="robot_navigation/videos/2dposeWrong_house_map.gif" width="480" alt="Wrong Pose Demo GIF - House World">
...
<img src="robot_navigation/images/AMCL_Inital_Pose.png" width="480" alt="Initial Pose Set">

<img src="robot_navigation/images/AMCL_House_finalCorrectedPose.png" width="480" alt="Final Corrected Pose - House World">

<img src="robot_navigation/videos/2dpose_house_right.gif" width="480" alt="Correct Pose Demo GIF - House World">
...
**Robot moving with corrected pose:**

<img src="robot_navigation/videos/map1_correctedpose.gif" width="480" alt="Robot Moving with Corrected Pose - House World">

Full video: `robot_navigation/videos/map1_correctedpose.mp4`

Driving the robot around confirmed the alignment remained stable throughout,
with `/amcl_pose` continuously updating to reflect the robot's real-time
position in the house map.
...
<img src="custom_world/gazebo.png" width="480" alt="Robot in Custom World (Gazebo)">

<img src="custom_world/gazebo_rosgraph.png" width="480" alt="Gazebo Node/Topic Graph">

### Mapping the Custom World

<img src="custom_world/mapping.png" width="480" alt="Mapping the Custom World">

<img src="custom_world/mapping_rosgraph.png" width="480" alt="Mapping Node/Topic Graph">
...
<img src="custom_world/amcl_rosgraph.png" width="480" alt="AMCL Node/Topic Graph">

<img src="custom_world/localization.gif" width="480" alt="AMCL Localization in Custom World">
